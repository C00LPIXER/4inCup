...
export function Home() {
  ...
  const winner = finalMatch?.completed
    ? data.teams.find((t) => t.id === finalMatch.winnerId)
    : null;
  const showWinnerSlot = !!winner;
      ...
      <div className="relative z-10 container mx-auto px-4 py-6 flex flex-col gap-12">
        ...
        {showWinnerSlot && (
          <section className="text-center py-6 animate-in fade-in zoom-in duration-700">
            <div
              className={`backdrop-blur-md border-2 rounded-3xl p-8 max-w-2xl mx-auto shadow-2xl ${
                winner
